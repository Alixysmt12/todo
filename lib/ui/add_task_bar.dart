...
import 'package:flutter_to_do_app/widgets/input_field.dart';
...
class _AddTaskPageState extends State<AddTaskPage> {
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              MyInputWidget(title: "Title", hint: "Enter your title",controller: _titleController,),
              MyInputWidget(title: "Note", hint: "Enter your Note",controller: _noteController,),
              MyInputWidget(
                title: "Date",
  ...
  _validateDate(){
    ...
    if(_titleController.text.isNotEmpty && _noteController.text.isNotEmpty){
      ...
      colorText: pinkClr,
      backgroundColor: Colors.white,icon: Icon(Icons.warning_amber_rounded,color: Colors.red,));
